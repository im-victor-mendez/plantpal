 ...
 * @returns {React.JSX.Element}
 * @example <InputToggle name={`Friends to gift`} values={friends} setValue={setFriends} />
 */
export function InputToggle({ name, values, setValue }: ToggleProps): React.JSX.Element {
    const { toggle, Icon, toggleState } = useToggle({ iconTrue: ArrowUp, iconFalse: ArrowDown })
